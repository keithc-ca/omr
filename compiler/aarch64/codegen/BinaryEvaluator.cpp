    ...
    TR::InstOpCode::Mnemonic notOp, TR::CodeGenerator *cg)
{
    ...
    if (!(isShiftedBinaryOp(node, firstChild, secondChild, source1Node, source2Node, shiftNode, notNode, shiftValue)
            || ((!node->getOpCode().isSub())
                && isShiftedBinaryOp(node, secondChild, firstChild, source1Node, source2Node, shiftNode, notNode,
                    shiftValue)))) {
        return NULL;
    }
...
TR::Register *OMR::ARM64::TreeEvaluator::vmulInt64Helper(TR::Node *node, TR::Register *productReg, TR::Register *lhsReg,
...
TR::Register *OMR::ARM64::TreeEvaluator::vdivIntHelper(TR::Node *node, TR::Register *resultReg, TR::Register *lhsReg,
    TR::Register *rhsReg, TR::CodeGenerator *cg)
{
    struct DivOps {
 ...
 */
static TR::Register *vminmaxInt64Helper(TR::Node *node, bool isMax, TR::Register *resReg, TR::Register *lhsReg,
    TR::Register *rhsReg, TR::CodeGenerator *cg)
{
    /*
...
TR::Register *OMR::ARM64::TreeEvaluator::vminInt64Helper(TR::Node *node, TR::Register *resReg, TR::Register *lhsReg,
    TR::Register *rhsReg, TR::CodeGenerator *cg)
{
    return vminmaxInt64Helper(node, false, resReg, lhsReg, rhsReg, cg);
}

TR::Register *OMR::ARM64::TreeEvaluator::vmaxInt64Helper(TR::Node *node, TR::Register *resReg, TR::Register *lhsReg,
    TR::Register *rhsReg, TR::CodeGenerator *cg)
{
