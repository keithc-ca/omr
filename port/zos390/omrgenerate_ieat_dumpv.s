...
***********************************************************************
         ...
         TITLE 'omrgenerate_ieat_dumpv.s'

* TDUMP DSN validation - must only be called on systems
* that indicate support for DSNTEST=YES is available.
         AIF ('&SYSPARM' EQ 'BIT64').JMP1
_TDUMPV  EDCXPRLG BASEREG=8
...
* Suppress the actual test until the definition of IEATDUMP is updated.
         AIF ('disabled' EQ 'disabled').JMP0
* Note: the SDATA options here must match those used in _TDUMP.
